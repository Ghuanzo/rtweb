!function (e, t) {
  ...
  const o = {}, i = e => new Promise(t => {
    if (!e) return t.get(e(t, n));
    const n = window.scrollX, i = window.scrollY;
    o.restoreFocusTimeout = setTimeout(() => {
      o.previousActiveElement instanceof HTMLElement ? (o.previousActiveElement.focus(), o.previousActiveElement = null) : document.body && document.body.focus(), t.get(e(t, n));
    }, 100), window.scrollTo(n, i);
  }), s = "swal2-", r = ["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "show", "hide", "close", "title", "html-container", "actions", "confirm", "deny", "cancel", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error", "draggable", "dragging"].reduce((e, t) => (e[t] = s + t, e), {}), a = ["success", "warning", "info", "question", "error"].reduce((e, t) => (e[t] = s + t, e), {}), l = "SweetAlert2:", c = e => e.charAt(0).toUpperCase() + e.slice(1), u = e => {
  ...
  }, w = e => v(`.${e}`), C = () => w(r.popup), A = () => w(r.icon), E = () => w(r.title), k = () => w(r["html-container"]), B = () => w(r.image), $ = () => w(r["progress-steps"]), L = () => w(r["validation-message"]), P = () => v(`.${r.actions} .${r.confirm}`), x = () => v(`.${r.actions} .${r.cancel}`), T = () => v(`.${r.actions} .${r.deny}`), S = () => v(`.${r.loader}`), O = () => w(r.actions), M = () => w(r.footer), H = () => w(r["timer-progress-bar"]), j = () => w(r.close), I = () => {
    const e = C();
    if (!e) return [];
    ...
    if (e.textContent = "", t) {
      ...
      i && Array.from(i.childNodes).forEach(t => {
        t instanceof HTMLVideoElement || t instanceof HTMLAudioElement ? e.appendChild(t.cloneNode(true)) : e.appendChild(t);
      });
    }
    ...
    t ? X(e, n) : Z(e);
  }, ee = e => Boolean(e && (e.offsetWidth || e.offsetHeight || e.getClientRects().length)), te = e => Boolean(e.scrollHeight > e.clientHeight), ne = e => {
    ...
    const t = (() => {
      const e = y();
      return !!e && (e.remove(), W([document.documentElement, document.body], [r["no-backdrop"], r["toast-shown"], r["has-column"]]), true);
    })();
    ...
    i.appendChild(n), e.topLayer && (n.setAttribute("popover", ""), n.showPopover()), (e => {
      ...
      "rtl" === window.getComputedStyle(e).direction && (z(y(), r.rtl), o.isRTL = true);
    })(i), (() => {
      const e = C();
      if (!e) return;
      const t = K(e, r.input), n = K(e, r.file), o = e.querySelector(`.${r.range} input`), i = e.querySelector(`.${r.range} output`), s = K(e, r.select), a = e.querySelector(`.${r.checkbox} input`), l = K(e, r.textarea);
    ...
    if (e.textContent = "", 0 in t) for (let n = 0; n in t; n++) e.appendChild(t[n].cloneNode(true)); else e.appendChild(t.cloneNode(true));
  }, ue = (e, t) => {
    const n = O(), o = S();
  ...
  Ae.text = Ae.email = Ae.password = Ae.number = Ae.tel = Ae.url = Ae.search = Ae.date = Ae["datetime-local"] = Ae.time = Ae.week = Ae.month = (e, t) => {
    ...
    if (n.textContent = "", t.inputPlaceholder) {
      ...
      q(e, t.inputPlaceholder), e.value = "", e.disabled = true, e.selected = true, n.appendChild(e);
    }
    return ve(n, n, t), n;
  ...
  let xe = false, Te = 0, Se = 0, Oe = 0, Me = 0;
  const He = e => {
    const t = C();
    if (!t) return;
    const n = A();
    ...
    Ve(0, t), pe(0, t), ((e, t) => {
      ...
      o && 0 !== o.length && undefined !== i ? (X(n), n.textContent = "", i >= o.length && u("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.forEach((e, s) => {
        const a = Ne(e);
    ...
    const i = C();
    "function" == typeof t.didRender && i && t.didRender(i), null === (n = o.eventEmitter) || undefined === n || n.emit("didRender", i);
  }, Re = () => {
    var e;
    return null === (e = P()) || undefined === e ? undefined : e.click();
  }, Ue = Object.freeze({cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer"}), ze = e => {
    if (e.keydownTarget && e.keydownHandlerAdded && e.keydownHandler) {
      const t = e.keydownHandler;
      e.keydownTarget.removeEventListener("keydown", t, {capture: e.keydownListenerCapture}), e.keydownHandlerAdded = false;
    }
  }, We = (e, t) => {
    var n;
    const o = I();
    return o.length ? (-2 === (e += t) && (e = o.length - 1), e === o.length ? e = 0 : -1 === e && (e = o.length - 1), o[e].focus(), !(navigator.userAgent.includes("Firefox") && o[e] instanceof HTMLIFrameElement)) : (null === (n = C()) || undefined === n || n.focus(), true);
  ...
  }, nt = "undefined" != typeof window && Boolean(window.GestureEvent), ot = nt && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, it = () => {
    const e = y();
    if (!e) return;
    let t;
    e.ontouchstart = e => {
  ...
  }, rt = e => Boolean(e.touches && e.touches.length && "stylus" === e.touches[0].touchType), at = e => e.touches && e.touches.length > 1;
  let lt = null;
  const ct = e => {
  ...
  function dt(e) {
    ...
    this.isAwaitingPromise ? e.isDismissed || (ht(this), e.get(e(e, n))) : n && e.get(e(e, n));
  }
  const pt = e => {
    const t = C();
    if (!t) return false;
    ...
    const o = y();
    return W(o, n.showClass.backdrop), z(o, n.hideClass.backdrop), ft(e, t, n), true;
  };
  function mt(e) {
    const t = et.swalPromiseReject.get(this);
    ht(this), t && e.get(e(e, n));
  }
  const ht = e => {
    e.isAwaitingPromise && (delete e.isAwaitingPromise, me.innerParams.get(e) || e._destroy());
  }, gt = e => undefined === e ? {isConfirmed: false, isDenied: false, isDismissed: true} : Object.assign({isConfirmed: false, isDenied: false, isDismissed: false}, e), ft = (e, t, n) => {
    var i;
    const s = y(), r = ne(t);
    "function" == typeof n.willClose && n.willClose(t), null === (i = o.eventEmitter) || undefined === i || i.emit("willClose", t), r && s ? bt(e, t, s, Boolean(n.returnFocus), n.didClose) : s && ut(e, s, Boolean(n.returnFocus), n.didClose);
  }, bt = (e, t, n, i, s) => {
    o.swalCloseEventFinishedCallback = ut.bind(null, e, n, i, s);
    const r = function (e) {
      var n;
      e.target === t && (null === (n = o.swalCloseEventFinishedCallback) || undefined === n || n.call(o), delete o.swalCloseEventFinishedCallback, t.removeEventListener("animationend", r), t.removeEventListener("transitionend", r));
    };
    t.addEventListener("animationend", r), t.addEventListener("transitionend", r);
  }, yt = (e, t) => {
    setTimeout(() => {
      var n;
      "function" == typeof t && t.bind(e.params)(), null === (n = o.eventEmitter) || undefined === n || n.emit("didClose"), e._destroy && e._destroy();
    });
  }, vt = e => {
    let t = C();
      ...
      "select" === t.input ? function (e, t, n) {
        ...
        t.forEach(e => {
          ...
          if (Array.isArray(n)) {
            ...
            e.label = t, e.disabled = false, o.appendChild(e), n.forEach(t => i(e, t[1], t[0]));
          } else i(o, n, t);
        }), o.focus();
        ...
        t.forEach(e => {
          ...
          s.type = "radio", s.name = r.radio, s.value = t, Lt(t, n.inputValue) && (s.checked = true);
  ...
  const $t = e => (e instanceof Map ? Array.from(e) : Object.entries(e)).map(([e, t]) => [e, "object" == typeof t ? $t(t) : t]), Lt = (e, t) => Boolean(t) && null != t && t.toString() === e.toString(), Pt = (e, t) => {
    const n = me.innerParams.get(e);
    ...
    if (n.showLoaderOnDeny && vt(T()), n.preDeny) {
      e.isAwaitingPromise = true;
      Promise.resolve().then(() => f(n.preDeny(t, n.validationMessage))).then(n => {
        false === n ? (e.hideLoading(), ht(e)) : e.close({isDenied: true, value: undefined === n ? t : n});
      }).catch(t => Ot(e, t));
    } else e.close({isDenied: true, value: t});
  }, St = (e, t) => {
    e.close({isConfirmed: true, value: t});
  }, Ot = (e, t) => {
    e.rejectPromise(t);
  }, Mt = (e, t) => {
    const n = me.innerParams.get(e);
    if (n.showLoaderOnConfirm && vt(), n.preConfirm) {
      e.resetValidationMessage(), e.isAwaitingPromise = true;
      Promise.resolve().then(() => f(n.preConfirm(t, n.validationMessage))).then(n => {
        ee(L()) || false === n ? (e.hideLoading(), ht(e)) : St(e, undefined === n ? t : n);
      }).catch(t => Ot(e, t));
    } else St(e, t);
  };
  function Ht() {
  ...
  function Nt() {
    me.focusedElement.set(this, document.activeElement), Dt(this, ["confirmButton", "denyButton", "cancelButton"], true);
  }
  function _t() {
  ...
  const zt = {title: "", titleText: "", text: "", html: "", footer: "", icon: undefined, iconColor: undefined, iconHtml: undefined, template: undefined, toast: false, draggable: false, animation: true, theme: "light", showClass: {popup: "swal2-show", backdrop: "swal2-backdrop-show", icon: "swal2-icon-show"}, hideClass: {popup: "swal2-hide", backdrop: "swal2-backdrop-hide", icon: "swal2-icon-hide"}, customClass: {}, target: "body", color: undefined, backdrop: true, heightAuto: true, allowOutsideClick: true, allowEscapeKey: true, allowEnterKey: true, stopKeydownPropagation: true, keydownListenerCapture: false, showConfirmButton: true, showDenyButton: false, showCancelButton: false, preConfirm: undefined, preDeny: undefined, confirmButtonText: "OK", confirmButtonAriaLabel: "", confirmButtonColor: undefined, denyButtonText: "No", denyButtonAriaLabel: "", denyButtonColor: undefined, cancelButtonText: "Cancel", cancelButtonAriaLabel: "", cancelButtonColor: undefined, buttonsStyling: true, reverseButtons: false, focusConfirm: true, focusDeny: false, focusCancel: false, returnFocus: true, showCloseButton: false, closeButtonHtml: "&times;", closeButtonAriaLabel: "Close this dialog", loaderHtml: "", showLoaderOnConfirm: false, showLoaderOnDeny: false, imageUrl: undefined, imageWidth: undefined, imageHeight: undefined, imageAlt: "", timer: undefined, timerProgressBar: false, width: undefined, padding: undefined, background: undefined, input: undefined, inputPlaceholder: "", inputLabel: "", inputValue: "", inputOptions: {}, inputAutoFocus: true, inputAutoTrim: true, inputAttributes: {}, inputValidator: undefined, returnInputValueOnDeny: false, validationMessage: undefined, grow: false, position: "center", progressSteps: [], currentProgressStep: undefined, progressStepsDistance: undefined, willOpen: undefined, didOpen: undefined, didRender: undefined, willClose: undefined, didClose: undefined, didDestroy: undefined, scrollbarPadding: true, topLayer: false}, Wt = ["allowEscapeKey", "allowOutsideClick", "background", "buttonsStyling", "cancelButtonAriaLabel", "cancelButtonColor", "cancelButtonText", "closeButtonAriaLabel", "closeButtonHtml", "color", "confirmButtonAriaLabel", "confirmButtonColor", "confirmButtonText", "currentProgressStep", "customClass", "denyButtonAriaLabel", "denyButtonColor", "denyButtonText", "didClose", "didDestroy", "draggable", "footer", "hideClass", "html", "icon", "iconColor", "iconHtml", "imageAlt", "imageHeight", "imageUrl", "imageWidth", "preConfirm", "preDeny", "progressSteps", "returnFocus", "reverseButtons", "showCancelButton", "showCloseButton", "showConfirmButton", "showDenyButton", "text", "title", "titleText", "theme", "willClose"], Kt = {allowEnterKey: undefined}, Yt = ["allowOutsideClick", "allowEnterKey", "backdrop", "draggable", "focusConfirm", "focusDeny", "focusCancel", "returnFocus", "heightAuto", "keydownListenerCapture"], Xt = e => Object.prototype.hasOwnProperty.call(zt, e), Zt = e => -1 !== Wt.indexOf(e), Jt = e => Kt[e], Gt = e => {
  ...
  function nn(e) {
    ...
    tn(s), t && (t.dataset.swal2Theme = s.theme), Fe(this, s), me.innerParams.set(this, s), Object.defineProperties(this, {params: {value: Object.assign({}, this.params, e), writable: false, enumerable: true}});
  }
  const on = e => {
    const t = {};
  ...
  function sn() {
    var e;
    const t = me.domCache.get(this), n = me.innerParams.get(this);
    n ? (t.popup && o.swalCloseEventFinishedCallback && (o.swalCloseEventFinishedCallback(), delete o.swalCloseEventFinishedCallback), "function" == typeof n.didDestroy && n.didDestroy(), null === (e = o.eventEmitter) || undefined === e || e.emit("didDestroy"), rn(this)) : an(this);
  }
  const rn = e => {
    an(e), delete e.params, delete o.keydownHandler, delete o.keydownTarget, delete o.currentInstance;
  }, an = e => {
    e.isAwaitingPromise ? (ln(me, e), e.isAwaitingPromise = true) : (ln(et, e), ln(me, e), delete e.isAwaitingPromise, delete e.disableButtons, delete e.enableButtons, delete e.getInput, delete e.disableInput, delete e.enableInput, delete e.hideLoading, delete e.disableLoading, delete e.showValidationMessage, delete e.resetValidationMessage, delete e.close, delete e.closePopup, delete e.closeModal, delete e.closeToast, delete e.rejectPromise, delete e.update, delete e._destroy);
  }, ln = (e, t) => {
    for (const n in e) e[n].delete(t);
  };
  var cn = Object.freeze({__proto__: null, _destroy: sn, close: dt, closeModal: dt, closePopup: dt, closeToast: dt, disableButtons: Nt, disableInput: Ft, disableLoading: Ht, enableButtons: qt, enableInput: _t, getInput: It, handleAwaitingPromise: ht, hideLoading: Ht, rejectPromise: mt, resetValidationMessage: Ut, showValidationMessage: Rt, update: nn});
  const un = (e, t, n) => {
    t.popup.onclick = () => {
  ...
  const mn = e => {
    e.popup.onmousedown = () => {
      e.container.onmouseup = function (t) {
        e.container.onmouseup = () => {}, t.target === e.container && (pn = true);
      };
    };
  }, hn = e => {
    e.container.onmousedown = t => {
      t.target === e.container && t.preventDefault(), e.popup.onmouseup = function (t) {
        e.popup.onmouseup = () => {}, (t.target === e.popup || t.target instanceof HTMLElement && e.popup.contains(t.target)) && (pn = true);
      };
    };
  }, gn = (e, t, n) => {
    t.container.onclick = o => {
      pn ? pn = false : o.target === t.container && h(e.allowOutsideClick) && n(Ue.backdrop);
    };
  ...
  o.eventEmitter = new class {
    ...
    _getHandlersByEventName(e) {
      return undefined === this.events[e] && (this.events[e] = []), this.events[e];
    }
    on(e, t) {
    ...
    removeAllListeners(e) {
      undefined !== this.events[e] && (this.events[e].length = 0);
    }
    reset() {
      this.events = {};
    }
  };
  var An = Object.freeze({__proto__: null, argsToParams: e => {
    const t = {};
    return "object" != typeof e[0] || fn(e[0]) ? ["title", "html", "icon"].forEach((n, o) => {
      const i = e[o];
      "string" == typeof i || fn(i) ? t[n] = i : undefined !== i && d(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`);
    }) : Object.assign(t, e[0]), t;
  }, bindClickHandler: function (e = "data-swal-template") {
    wn[e] = this, vn || (document.body.addEventListener("click", Cn), vn = true);
  }, clickCancel: () => {
    var e;
    return null === (e = x()) || undefined === e ? undefined : e.click();
  }, clickConfirm: Re, clickDeny: () => {
    var e;
    return null === (e = T()) || undefined === e ? undefined : e.click();
  }, enableLoading: vt, fire: function (...e) {
    return new this(...e);
  }, getActions: O, getCancelButton: x, getCloseButton: j, getConfirmButton: P, getContainer: y, getDenyButton: T, getFocusableElements: I, getFooter: M, getHtmlContainer: k, getIcon: A, getIconContent: () => w(r["icon-content"]), getImage: B, getInputLabel: () => w(r["input-label"]), getLoader: S, getPopup: C, getProgressSteps: $, getTimerLeft: () => o.timeout && o.timeout.getTimerLeft(), getTimerProgressBar: H, getTitle: E, getValidationMessage: L, increaseTimer: e => {
    if (o.timeout) {
      const t = o.timeout.increase(e);
      return oe(t, true), t;
    }
  }, isDeprecatedParameter: Jt, isLoading: () => {
    const e = C();
    return !!e && e.hasAttribute("data-loading");
  }, isTimerRunning: () => Boolean(o.timeout && o.timeout.isRunning()), isUpdatableParameter: Zt, isValidParameter: Xt, isVisible: () => ee(C()), mixin: function (e) {
  ...
  }, resumeTimer: yn, showLoading: vt, stopTimer: bn, toggleTimer: () => {
    const e = o.timeout;
    return e && (e.running ? bn() : yn());
  }});
  class En {
    constructor(e, t) {
      this.callback = e, this.remaining = t, this.running = false, this.start();
    }
    start() {
    ...
    stop() {
      return this.started && this.running && (this.running = false, clearTimeout(this.id), this.remaining -= (new Date).getTime() - this.started.getTime()), this.remaining;
    }
    increase(e) {
  ...
  const kn = ["swal-title", "swal-html", "swal-footer"], Bn = e => {
    ...
    return Array.from(e.querySelectorAll("swal-button")).forEach(e => {
      ...
      t[`${n}ButtonText`] = e.innerHTML, t[`show${c(n)}Button`] = true;
    ...
    if (n) {
      ...
      null !== e && (t.imageUrl = e || undefined);
      const o = n.getAttribute("width");
      null !== o && (t.imageWidth = o || undefined);
      const i = n.getAttribute("height");
      null !== i && (t.imageHeight = i || undefined);
      const s = n.getAttribute("alt");
      null !== s && (t.imageAlt = s || undefined);
    }
    return t;
  }, xn = e => {
    ...
    const i = y(), s = C();
    if (!i || !s) return;
    "function" == typeof e.willOpen && e.willOpen(s), null === (t = o.eventEmitter) || undefined === t || t.emit("willOpen", s);
    const r = window.getComputedStyle(document.body).overflowY;
    if (Vn(i, s, e), setTimeout(() => {
      In(i, s);
    }, 10), D() && (Dn(i, undefined !== e.scrollbarPadding && e.scrollbarPadding, r), (() => {
      const e = y();
    ...
    })()), ot && false === e.backdrop && s.scrollHeight > i.clientHeight && (i.style.pointerEvents = "auto"), V() || o.previousActiveElement || (o.previousActiveElement = document.activeElement), "function" == typeof e.didOpen) {
      const t = e.didOpen;
      setTimeout(() => s.get(e(s, n)));
    }
    null === (n = o.eventEmitter) || undefined === n || n.emit("didOpen", s);
  }, jn = e => {
    const t = C();
    ...
    var o;
    null !== (o = n.showClass) && undefined !== o && o.backdrop && z(e, n.showClass.backdrop), n.animation ? (t.style.setProperty("opacity", "0", "important"), X(t, "grid"), setTimeout(() => {
      var e;
      null !== (e = n.showClass) && undefined !== e && e.popup && z(t, n.showClass.popup), t.style.removeProperty("opacity");
  ...
  var qn = (e, t) => /^[a-zA-Z0-9.+_'-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]+$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid email address"), Nn = (e, t) => /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid URL");
  function _n(e) {
    !function (e) {
  ...
  class Un {
    constructor(...t) {
      if (n(this, Rn, Promise.resolve({isConfirmed: false, isDenied: false, isDismissed: true})), "undefined" == typeof window) return;
      Fn = this;
      const o = Object.freeze(this.constructor.argsToParams(t));
      var i, s, r;
      this.params = o, this.isAwaitingPromise = false, i = Rn, s = this, r = this._main(Fn.params), i.set(e(i, s), r);
    }
    _main(e, t = {}) {
      if (tn(Object.assign({}, t, e)), o.currentInstance) {
        ...
        o.currentInstance._destroy(), t || e({isDismissed: true}), D() && tt();
      }
    ...
    then(e) {
      return Rn.get(e(Rn, this)).then(e);
    }
    finally(e) {
      return Rn.get(e(Rn, this)).finally(e);
    }
  }
  const zn = (e, t, n) => new Promise((i, s) => {
    const r = t => {
      e.close({isDismissed: true, dismiss: t, isConfirmed: false, isDenied: false});
    };
    et.swalPromiseResolve.set(e, i), et.swalPromiseReject.set(e, s), t.confirmButton.onclick = () => {
      (e => {
        const t = me.innerParams.get(e);
        e.disableButtons(), t.input ? Pt(e, "confirm") : Mt(e, true);
      })(e);
    }, t.denyButton.onclick = () => {
      (e => {
        const t = me.innerParams.get(e);
        e.disableButtons(), t.returnInputValueOnDeny ? Pt(e, "deny") : Tt(e, false);
      })(e);
    }, t.cancelButton.onclick = () => {
      ((e, t) => {
        e.disableButtons(), Ue.cancel.get(e(Ue.cancel, n));
      })(e, r);
      ...
      if (ze(e), !t.toast) {
        ...
        if (i) {
          ...
          const n = o;
          e.keydownTarget.addEventListener("keydown", n, {capture: e.keydownListenerCapture}), e.keydownHandlerAdded = true;
        }
      }
    })(o, n, r), ((e, t) => {
    ...
    return o.showClass = Object.assign({}, zt.showClass, o.showClass), o.hideClass = Object.assign({}, zt.hideClass, o.hideClass), false === o.animation && (o.showClass = {backdrop: "swal2-noanimation"}, o.hideClass = {}), o;
  }, Kn = e => {
    const t = {popup: C(), container: y(), actions: O(), confirmButton: P(), denyButton: T(), cancelButton: x(), loader: S(), closeButton: j(), validationMessage: L(), progressSteps: $()};
    ...
    for (const e of t) if (e instanceof HTMLElement && ee(e)) return e.focus(), true;
    return false;
  }, Jn = (e, t) => t.focusDeny && ee(e.denyButton) ? (e.denyButton.focus(), true) : t.focusCancel && ee(e.cancelButton) ? (e.cancelButton.focus(), true) : !(!t.focusConfirm || !ee(e.confirmButton)) && (e.confirmButton.focus(), true);
...
}), undefined !== this && this.Sweetalert2 && (this.swal = this.sweetAlert = this.Swal = this.SweetAlert = this.Sweetalert2);
